...
DeseventJs.sourceLink = "/list_image/payment";

DeseventJs.prototype.initialDom = function (type) {
      ...
      desktop: [
        {
          ...
          callback: function (id, source) {
            ...
            div_clone.id = id;
            div_clone.style.backgroundImage = "url('" + DeseventJs.sourceLink + source[0] +  "')";
            return div_clone;
          },
        },
        {
        ...
        },
        {
          ...
          callback: function (id, source) {
            ...
            img_clone.src = DeseventJs.sourceLink + source[0];
      ...
      desktop: [
        {
          ...
          callback: function (id, source) {
            var div_clone = GeneralJs.nodes.div.cloneNode(true);
            div_clone.id = id;
            // DeseventJs.sourceLink different point
      ...
      desktop: [
        {
          ...
          callback: function (id, source) {
            ...
            for (var i = 0; i < list.length; i++) {
              ...
              div_clone2.addEventListener("click", DeseventJs.termsEvent("desktop", i));
      ...
      mobile: [
        {
          ...
          callback: function (id, source) {
            ...
            for (var i = 0; i < list.length; i++) {
              ...
              div_clone2.classList.add("termslabel");
              div_clone2.insertAdjacentHTML("beforeend", list[i]);
              div_clone2.addEventListener("click", DeseventJs.termsEvent("mobile", i));
              h2.appendChild(div_clone2);
            }
            div_clone.appendChild(h2);
            return div_clone;
      ...
      desktop: [
        {
          ...
          callback: function (needs) {
            ...
            div_clone.style.backgroundImage = "url('" + DeseventJs.sourceLink + needs.source[0] +  "')";
      ...
      desktop: [
        {
          ...
          callback: function (needs) {
            ...
            div_clone.classList.add("paymentblock_detail");
            div_clone.style.position = "absolute";
            div_clone.style.backgroundImage = "url('" + DeseventJs.sourceLink + needs.source[1] +  "')";
            div_clone.style.width = "99.9%";
            div_clone.style.height = "365px";
            dom.appendChild(div_clone);
...
DeseventJs.prototype.baseMaker = function (type) {
  ...
  for (z = 0; z < flatform.length; z++) {
    ...
    if (this.blocks[type].length !== 0) {
      ...
      if (type === "channel") {
        ...
        img_clone.src = DeseventJs.sourceLink + "/whitemain/a1.svg";
        div_clone.addEventListener("click", this.eventMaker(type, (toggle ? "desktop" : "mobile")));
      }
...
DeseventJs.prototype.eventMaker = function (type, flatform) {
  if (type === "channel") {
    return function (e) {
    ...
    if (flatform === "desktop") {
      ...
      list.mo = '';
      list.source = [
        (DeseventJs.sourceLink + "/popup/a1.svg"),
        (DeseventJs.sourceLink + "/popup/a2.svg"),
        // DeseventJs.sourceLink position
        ("./list_image/consulting" + "/titlesub/a1.svg"),
        // DeseventJs.sourceLink position
        ("./list_image/consulting" + "/titlesub/a2.svg"),
        (DeseventJs.sourceLink + "/popup/a3.svg"),
        (DeseventJs.sourceLink + "/popup/b3.svg"),
        (DeseventJs.sourceLink + "/whitemain/a1.svg"),
      ];
      list.toggle = true;
      ...
      list.mo = "mo";
      list.source = [
        (DeseventJs.sourceLink + "/popup/moa1.svg"),
        (DeseventJs.sourceLink + "/popup/moa2.svg"),
        // DeseventJs.sourceLink position
        ("./list_image/consulting" + "/titlesub/a1.svg"),
        // DeseventJs.sourceLink position
        ("./list_image/consulting" + "/titlesub/a2.svg"),
    ...
    return function (e) {
      ...
      if (e.target.id !== "cancel_back" && e.target.id !== list.id && !e.target.classList.contains("white")) {
        ...
        div_clone4.insertAdjacentHTML("beforeend", DeseventJs.policy());
...
DeseventJs.termsEvent = function (flatform, m) {
  var list = [];
  var title = "";
