module.exports = function () {
  function css_degeneral(){
    ...
    html += ".consulting_input{width:100%;border:0;outline:0;background-color:transparent;font-family:'Noto Sans KR', sans-serif;font-size:14px;height:28.5px;text-decoration:none;text-transform:none;color:#303030;line-height:17px;letter-spacing:-0.50px;text-shadow:none;padding:0;padding-bottom:3px;}";
  ...
  function css_mogeneral(){
    ...
    html += ".moconsulting_input{width:100%;border:0;outline:0;background-color:transparent;font-family:'Noto Sans KR', sans-serif;font-size:3.4vw;height:6.4vw;text-decoration:none;text-transform:none;color:#303030;line-height:1.7;letter-spacing:-0.50px;text-shadow:none;padding:0;padding-bottom:0.5vw;}";
