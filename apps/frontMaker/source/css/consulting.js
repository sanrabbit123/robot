module.exports = function () {
  ...
  function css_mogeneral(){
    ...
    html += "#moconsultingtitle{display:block;position:absolute;transition:all 0.5s ease;}";
    ...
    html += ".moconsulting_inputblock{background: #f2f2f2;border-radius:3px;position:absolute;transition:opacity 0.5s ease;}";
    html += ".moconsulting_input{width:100%;height:100%;border:0;outline:0;background-color:transparent;font-family:'Noto Sans KR', sans-serif;font-size:3vw;height:6.4vw;text-decoration:none;text-transform:none;color:#303030;line-height:1.7;letter-spacing:-0.50px;text-shadow:none;padding:0;padding-bottom:0.5vw;}";
    ...
    html += ".moblocks_budgetbox_money{position:relative;display:inline-block;margin-left:10.5vw;height:5.5vw;cursor:pointer;width:16vw;overflow:visible;}";
    ...
    html += ".moblocks_budgetbox_money_on{position:absolute;opacity:0;top:0;background:white;transition:opacity 0.5s ease;}";
    ...
    html += ".moblocks_date_resident_on,.moblocks_contract_on{position:absolute;opacity:0;transition:opacity 0.5s ease;}";
    ...
    html += ".moblocks_space_on{background-color:#2fa678;opacity:0;transition:opacity 0.5s ease;}";
    ...
    html += ".mobelow_box_checkbox_on{opacity:0;transition:opacity 0.5s ease;}";
    ...
    html += ".mobelow_box_submit{position:absolute;height:4.3vw;left:50%;margin-left:-8vw;top:3.5vw;transition:opacity 0.5s ease;}";
    ...
    html += ".mobelow_servey_detail_on{opacity:0;transition:opacity 0.5s ease;}";
