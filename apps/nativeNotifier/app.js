...
const NativeNotifierApp = function () {
  this.mother = new Mother();
  this.address = ADDRESS;
}

NativeNotifierApp.prototype.databaseSetting = async function () {
  const instance = this;
...
NativeNotifierApp.prototype.launching = async function () {
  const instance = this;
...
const app = new NativeNotifierApp();
