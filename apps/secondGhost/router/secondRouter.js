  ...
  obj.func = async function (req, res, logger) {
    ...
    try {
      ...
      if (req.body.voice === true || req.body.voice === "true") {
        requestSystem("https://" + instance.address.memberinfo.host + "/textToVoice", { text }, { headers: { "Content-Type": "application/json" } }).catch((err) => { console.log(err); });
      }
...
SecondRouter.prototype.rou_post_voice = function () {
  ...
  obj.func = async function (req, res, logger) {
    ...
    try {
      ...
      requestSystem("https://" + address.memberinfo.host + "/textToVoice", {
        text: req.body.text,
      }, {
