...
class GoogleDrive:
    ...
    def permissionsOn(self, id):
        ...
        return { "link": webViewLink["webViewLink"] }
    ...
    def webPublish(self, file_id):
        ...
        return { "link": "https://docs.google.com/spreadsheets/d/" + file_id + "/pubhtml?widget=true&headers=false&embedded=true" }
    ...
    def downloadFile(self, target_id, target_folder):
        ...
        return { "message": info["name"] + " download done" }
