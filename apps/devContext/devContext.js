...
DevContext.prototype.launching = async function () {
  ...
  try {
    ...
    let res;
    console.log(logView);
    res = await requestSystem("https://" + instance.address.pythoninfo.host + ":3000/cashReceipt", results[1], { headers: { "Content-Type": "application/json" } });
    console.log(res.data);
    res = await requestSystem("https://" + instance.address.pythoninfo.host + ":3000/cashReceipt", results[2], { headers: { "Content-Type": "application/json" } });
    console.log(res.data);
