  ...
  try {
    ...
    noticeModules = {
      methods: {
        ...
        children: [
          ...
          },
          {
            name: "홈스타일링",
            contents: [
              "욕실, 싱크대 교체를 제외한 최소 시공에 스타일링 마무리",
          ...
          },
          {
            name: "토탈 스타일링",
            contents: [
              "욕실, 싱크대 교체를 포함한 전체 시공에 스타일링 마무리",
      ...
      items: {
        ...
        children: [
          {
            name: "디자이너와 새로운 방법으로 집을 꾸며보세요. 일단 시공부터 시작하고 보는 것이 아니라 공간, 시간, 예산을 어떻게 사용할지 <b%디자이너와 함께%b> 계획해서 <u%여건에 맞는 시공 범위%u>를 정하고, <u%스타일링까지 마무리%u>하여 오롯이 쉴 수 있는 나만의 공간 경험을 전해드립니다.",
            contents: [
              "전체 컨셉 설정",
              "공간 배치",
              "시공 범위 제안",
      ...
      site: {
        ...
        children: [
          {
            name: "현장 조사 관련 디자이너 역할",
            contents: [
              "현장 조사 : 현장에 대한 <b%특이사항 파악과 실측이 중요%b>합니다. 현장 방문이 어려운 경우, 현 거주지 또는 외부에서 만나실 수 있지만 제품 구매 및 시공 계약 전의 현장 방문은 필수입니다.",
              "도면 확인 : <b%현장의 도면을 준비해주세요.%b> 적절한 도면이 없는 경우 실측을 통해 디자이너가 기록하지만 시간이 지체될 수 있습니다.",
              "실측 : 도면이 있다고 해도 실제와 다를 수 있습니다. <b%도면보다 실측이 더 중요하므로 디자이너는 반드시 실측을 진행%b>합니다.",
            ]
          }
        ]
      },
      needs: {
        ...
        children: [
          {
            name: "니즈 조사 관련 디자이너 역할",
            contents: [
              "니즈 조사 : 디자이너는 고객님이 전송해주신 자료를 바탕으로 <b%미팅 사전 준비를 합니다.%b> 그리고 <b%현장에서 고객님의 이야기를 들어 니즈를 파악%b>합니다.",
              "예산 확인 : 니즈와 항상 더불어 고려해야 하는 것은 예산입니다. 디자이너는 <b%예산에 대한 범위 확인과 어떻게 나누어 쓸 지를 파악%b>하게 됩니다.",
              "시공 조정 : 디자이너는 고객님의 니즈와 예산의 균형적인 분배, 기존 현장의 상태를 <b%종합적으로 판단하여 시공의 범위를 조정%b>하게 됩니다.",
            ]
          }
        ]
      },
      concept: {
        ...
        children: [
          {
            name: "컨셉 잡기 관련 디자이너 역할",
            contents: [
              "컨셉 잡기 : 컨셉은 <b%모든 디자인의 기준이 되므로 매우 중요%b>합니다. 이미지 기반의 제안 및 고객님의 동의 과정을 통해서 이후 디자인 작업이 진행되고, 컨셉은 계속 변경할 수 없습니다.",
              "이미지 기반 : 추상적인 단어와 문장들로만 컨셉을 잡는 것이 아니라, <b%사진이나 이미지 등을 활용하여 디자인 컨셉%b>을 잡습니다. 컨셉 의논이 길게 소요되는 경우 <b%프로젝트 시작 후의 1차 시안에 해당 작업이 포함될 수 있습니다.%b>",
              "용도 확인 : 고객님의 라이프 스타일과 가족 구성원을 기반으로 <b%공간 용도와 동선을 기획%b>합니다.",
            ]
          }
        ]
      },
        ...
        children: [
          {
            name: "진행 취소시 주의 사항",
            contents: [
              "디자이너 변경 : 현장 미팅 후 디자이너와 잘 맞지 않는다고 판단될 시, <b%최대 1회까지 디자이너 변경을 요청%b>하실 수 있습니다. (거리로 인해 출장비가 발생한 경우, 변경 디자이너에 대한 출장비는 재발생됩니다.)",
              "진행 취소시 : 현장 미팅 이후 진행 자체를 취소하실 시 <b%계약금은 환급되지 않습니다.%b>",
            ]
          }
        ]
      },
        ...
        children: [
          {
            name: "카드 결제 완료",
            contents: [
              "결제가 완료되었으며, 다음 과정 안내를 위해 홈리에종에서 연락이 갈 수 있습니다.",
              "기타 문의 사항은 02-2039-2252 으로 전화 주시거나, <u%카카오톡 홈리에종 채널을 통해 문의 부탁%u>드립니다!"
            ]
          }
        ]
      },
        ...
        children: [
          {
            name: "가상 계좌 발급 완료",
            contents: [
              "- 까지 다음 가상계좌를 통해 입금해주시면 결제가 완료됩니다!",
              "가상계좌 정보 : -"
            ]
          }
        ]
        ...
        children: [
          {
            name: "기본적인 순서",
            contents: [
              "6가지 과정 : 인테리어의 기본적인 순서는 1 <b%실측%b>, 2 <b%디자인(설계)%b>, 3 <b%견적%b>, 4 <b%시공(제작)%b>, 5 <b%구매%b>, 6 <b%세팅%b> 으로 이루어집니다. <b%누락되거나 순서가 뒤바뀐 경우, 문제가 발생%b>할 수 있습니다.",
            ],
          },
          {
            name: "디자인 일정",
            contents: [
              "1차 제안 : 디자이너는 현장 상태와 예산을 고려해서 <b%컨셉을 잡고 디자인을 진행하여 도면 또는 디자인 시안의 형태로 어떻게 집을 만들지 제안%b>하게 됩니다. 페이퍼 워크의 형태는 디자이너마다 다를 수 있습니다.",
              "수정 제안 : 디자인 제안은 <b%보통 2~3회 정도 수정을 거치며 고객님과 의견을 조율%b>해 완성해 나아갑니다. 일정에는 디자인 수정에 대한 시간적 고려가 반영되어 있어야 합니다.",
            ],
          },
          {
            name: "견적 일정",
            contents: [
              "시공사 선택 : 디자이너 시공사 또는 홈리에종 시공사로부터 <b%견적서를 받고 비교하여 시공사를 선택할 수 있는 과정%b>이 있습니다. 여러 업체에서 견적을 많이 받을수록 일정 기간이 늘어날 수 있습니다.",
              "견적 수정 : 시공사 선택 후, 견적을 받고 견적을 수정할 수 있는 과정입니다. 공사가 시작된 후 공사 내역이 생기거나 수정될 시 추가 비용이 발생될 수 있기 때문에, <b%누락된 공사 항목은 없는지 꼼꼼하게 확인해야 하는 단계%b>입니다.",
            ],
          },
          {
            name: "시공 일정",
            contents: [
              "공정표 제공 : 시공이 <b%시작되면 시공사가 공정표를 제공%b>합니다. 공정표는 일반적으로 철거 -> 전기, 설비 -> 목공 -> 도장 -> 타일 -> 금속 -> 마감 순으로 되어 있습니다. 현장 상황에 따라 구체적인 순서는 달라질 수 있습니다.",
              "추가 공사 방지 : 견적대로 진행하는 것이 중요하며, <b%부득이하게 수정 또는 추가 요청이 있을 경우, 공정상 언제 요청하는지에 따라 비용과 시간이 크게 늘어날 수%b> 있습니다.",
            ],
          },
          {
            name: "구매 일정",
            contents: [
              "리스트 제공 : 입주 청소가 끝나는 타이밍에 맞춰 제품이 올 수 있도록 디자이너는 <b%구체적인 제품과 스펙과 구매처(링크)가 적혀 있는 리스트를 제공%b>합니다. 구매 대행은 진행해드리지 않으며, 직접 구입해주시면 됩니다.",
              "배송 고려 : 구매 일정에서 가장 중요한 것은 배송에 대한 고려입니다. 제품마다 배송 일자가 모두 다르고 <b%변수도 많기 때문에 일정의 여유를 두고 구매를 진행%b>하시는 것이 중요합니다.",
            ],
          },
          {
            name: "세팅 일정",
            contents: [
              "세팅 가이드 : 디자이너는 가구와 제품의 <b%배치도를 통해 어떤 것을 어디에 둘 지에 대한 구체적인 가이드를 제공%b>합니다. 디자이너가 직접 조립 및 설치를 도와드리지는 않습니다.",
              "촬영 조율 : 구매와 세팅이 모두 완료되면 홈리에종 통해 촬영 일자를 잡게 되며, 촬영 일자에 맞춰 촬영과 인터뷰를 진행하게 됩니다.",
            ],
          },
        ]
      },
    ...
    for (let key in noticeModules) {
      tempArr = [];
      tempArr.push(noticeModules[key].name);

      tempStr = '';
      for (let { name, contents } of noticeModules[key].children) {
        tempStr += name;
        tempStr += "\n\n";
        tempStr += contents.join("\n").replace(/\<[ub]\%/gi, '').replace(/\%[ub]\>/gi, '');
        tempStr += "\n\n";
        tempStr += "-";
        tempStr += "\n\n";
      }

      tempArr.push(tempStr.slice(0, -3));

      tempArr.push(key);
      matrix.push(tempArr);
    }

    await sheets.update_value_inPython(sheetsId, sheetsName, matrix);
    console.log(matrix);
