...

    {
      ...
      contents: {
        ...
        detail: [
          ...
          {
            type: "generalDescription",
            text: [
              "모든 집에는 벽이 있다. 집에서 아주 많은 면적을 차지하는 벽을 잘 꾸미는 것은 인테리어 성공의 지름길이다. 멋진 인테리어는 절대로 벽을 낭비하지 않는다. 우리 집에도 꾸밀 벽이 있는지 떠올려보자.",
              "1) 아파트에서 찾아볼 수 있는 전형적인 구조의 벽이 있다. 현관 신발장 입구에서 바라보는 복도 벽이다. 여기에 와우 포인트를 주면 집의 첫인상이 멋지다. 2) 데드 스페이스를 활용한다. 분명히 냉장고 문 또는 방문이 열리는 방향 탓에 쓰이지 못하는 벽이 있을 것이다. 3) 가구 주변의 벽을 함께 꾸미면 배치한 그 가구를 더욱 빛나게 한다. 4) 충분한 양의 가구가 벽을 메우지 못한 경우가 있다. 미니멀 라이프를 지향해서 최소한의 가구만 두더라도 휑한 벽에 포인트를 주면 자칫 단조로울 수 있는 공간에 무게감이 생긴다.",
          ...
          },
          {
            type: "generalDescription",
            text: [
              "디자인 벽지와 같은 효과를 원하지만 가구와 짐을 비우고 도배를 할 수 없는 상황이라면, 가능한 범위에 부분적으로 연출이 가능한 것이 장점인 실크 스크린과 스텐실, 스티커를 활용할 수 있다.",
          ...
          },
          {
            ...
            source: [
              [ "/b1.jpg", "/b2.jpg" ],
              [ "/mobile/mob1.jpg", "/mobile/mob2.jpg" ],
            ]
          },
          {
            type: "blankDescription",
            text: [
              "세 가지 기법은 유사하면서도 작은 차이점들이 있다. 실크 스크린은 도료로 작업하고 꽤 정교한 표현이 가능해서 가장 퀄리티가 좋지만 난이도 또한 가장 높으니 전문 업체에 맡기는 것을 권장한다. 스텐실은 상대적으로 간단한 틀을 대고 물감을 찍어내는 방식이므로 손재주가 있으면 셀프로 도전할 수 있다. 벽지 스티커는 가장 쉽고 간편한 방식이며, 비닐로 되어 있어 청소와 유지가 쉽고 습기에 강하다.",
            ],
          },
          {
            type: "blankTitle",
          ...
          },
          {
            type: "generalDescription",
            text: [
              "쓸모없는 벽에 실용성을 더해 쓸모 있게 만드는 방법으로는 단연 벽 선반이 최고다. 수납 가구의 역할을 어느 정도 수행하면서도 하부를 띄워 설치할 수 있어서 공간 활용에 좋으며, 특히 대가구 주변에 설치하는 것을 추천한다. 소파 주변 벽 선반에 리모컨과 읽을 책을 두면 물건을 쉽게 찾을 수 있고 동선이 편안하다. 침대 주변 벽 선반에 알람 시계와 수면 램프를 두면 침대 협탁이 따로 필요 없다.",
            ],
          },
          {
            type: "blankImage",
          ...
          },
          {
            type: "blankDescription",
            text: [
              "크고 작은 크기부터, 나무와 철제까지 다채로운 벽 선반 제품이 시중에 있으니 그 실용성을 극대화할 수 있도록 어떤 것을 비치할 목적인지 생각해 보고 고르는 것이 좋겠다. 수납 목적에는 튼튼한 시스템 선반이나 찬넬 선반이 적합하다. 데코 목적이 중점일 경우에는 무지주 선반이 괜찮은데, 선반을 받쳐주는 지지대가 밖으로 보이지 않는 깔끔한 형태라 그 위에 장식품이나 작은 액자, 디퓨저 등을 올려주면 인테리어 소품이 도드라진다.",
            ],
          },
          {
            type: "blankImage",
            ...
            source: [
              [ "/c1.jpg", "/c2.jpg" ],
              [ "/mobile/moc1.jpg", "/mobile/moc2.jpg" ],
            ]
          },
          {
            type: "blankDescription",
            text: [
              "혹은 선반에 특별히 멋있는 것을 두지 않아도, 선반 자체를 오브제 삼아 여러 개를 배열하여 율동감을 표현할 수도 있다. 타공을 하고 못을 박기 어려운 임차 공간에도 꼭꼬핀을 사용하거나 부착식, 흡착식으로 설치하는 노하우가 있으니 낙담하지 않아도 된다. 아쉽지만 지지력이 약하니 수납 목적보다는 데코용으로 가벼운 제품을 선택하는 것이 좋다.",
          ...
          },
          {
            type: "generalDescription",
            text: [
              "비어 있는 벽을 꼭 채우기는 싫으면서도, 무언가 포인트나 기능은 있었으면 하는 두 가지 마음이 공존한다면 빛을 활용하여 자유롭게 사용될 수 있는 여지를 두면 된다.",
              "벽 자체에 벽부등이나 브라켓 조명을 설치할 수도 있지만, 그때그때 마음 가는 대로 변형이 가능하도록 완전히 벽을 자유롭게 하는 방식으로 제안한다. 벽이 아닌 천장에 핀 조명을 설치하고 벽을 따라 떨어지는 빛의 중심에 물건을 놓는다. 디자인 의자와 같이 가구 자체를 하나의 작품처럼 두어도 좋고, 피규어와 액자를 배치하면 우리 집만의 갤러리가 된다. 공사가 필요 없이, 스탠딩 조명과 테이블 조명을 벽면에 비추는 것도 똑똑하다. 거기에 어릴 때 하던 그림자 놀이를 응용해서 빛이 향하는 방향에 오브제를 두면 재미 요소가 생긴다.",
            ],
          },
          {
            type: "blankImage",
            ...
            source: [
              [ "/d0.jpg", "/d1.jpg" ],
              [ "/mobile/mod0.jpg", "/mobile/mod1.jpg" ],
            ]
          },
          {
            type: "generalImage",
          ...
          },
          {
            type: "blankDescription",
            text: [
              "벽은 빔 프로젝터를 쏘는 스크린으로 변신하기도 한다. 아무래도 화이트 계열의 벽이 좋을 것이다. 특히 작은 평수의 집에서는 부피가 크고 짐이 되는 스크린을 쌓아두지 않을 수 있어 효율적이다. 비록 실제 스크린에 비하면 화질의 차이가 있겠지만, 스크린을 사는 돈을 절약했으니 빔 프로젝터를 고성능으로 업그레이드해 보자. 영화를 보고 야구나 축구 등의 스포츠 경기를 시청하며 즐거움을 누리고, 액자를 대신해서 그림 작품을 띄워놓는 것도 멋질 테니 최고의 컨버터블 벽 꾸미기 방법.",
            ],
          },
          {
            type: "blankTitle",
          ...
          },
          {
            type: "generalDescription",
            text: [
              "진정한 수집광들은 자신들의 수집품을 자랑하거나 고이 모실 공간이 필요하고, 실제로 박물관 관장들 중에는 수집광이 아주 많다. 그동안 정성스레 모아 온 물품으로 채운 벽은 더욱 애정이 갈 것이며, 하나의 전시 공간이 된다.",
            ],
          },
          {
            type: "blankImage",
          ...
          },
          {
            type: "generalDescription",
            text: [
              "인테리어 트렌드도 시대에 걸맞게 친환경 키워드를 반영하고 있다. 그린 월은 벽면을 각종 식물로 입힌 형태를 의미한다. 본래 실외 건축에서 도심 속 열섬효과를 방지하고 건물의 에너지 효율을 높여주는 대표적인 친환경 조경 방식으로 많이 사용되어 왔다.",
            ],
          },
          {
            type: "blankImage",
          ...
          },
          {
            ...
            source: [
              [ "/f1.jpg", "/f2.jpg" ],
              [ "/mobile/mof1.jpg", "/mobile/mof2.jpg" ],
            ]
          },
          {
            type: "blankDescription",
            text: [
              "이제는 그린월이 인테리어에 접목되는 기술이 발전하면서 그 유익한 점도 그대로 실내로 들어왔다. 1) 공기를 정화해 주고 온도와 습도를 생명 친화적으로 유지해 준다. (보통의 공기청정기는 미세먼지를 걸러주지만 화학물을 분해하고 거르지는 못한다.) 그래서 비염이 있는 아이들이 있는 집이나, 기관지가 안 좋은 어르신들이 있는 집에 추천한다. 또는 병원과 같은 의료기관에도 적합하다. 2) 식물의 녹색이 스트레스를 해소하고 심신의 평안을 준다. 오피스와 공공 기관에 녹색을 사용해서 정신의 피로를 덜어보자.",
              "이렇게 좋은 그린월을 설치하려면 다음의 사항을 체크해야 한다. 급배수 시설의 연결이 가능한지, 식물의 종류에 따라 채광과 습도 등을 고려하여 설치 위치와 관리 측면을 살펴야 한다. 특히 급배수 시설의 조건 때문에 주거공간에서는 주로 화장실 또는 베란다에 그린월을 많이 활용하는 편이다.",
          ...
          },
          {
            type: "generalDescription",
            text: [
              "대중에게 가장 친숙하고 쉬운 방법은 아이템을 구매해서 데코하는 것이다. 하지만 액자는 지겹고 보다 특별한 아이템을 원한다면, 헌팅 트로피 / 패브릭 월 행잉 / 금속 오브제 / 시계 / 액자 등의 폭넓은 선택지가 있다. 내추럴 코지 컨셉에는 패브릭으로, 모던 시크 컨셉에는 금속 오브제로 우리 집 무드에 맞는 아이템을 고르면 컨셉의 매력이 배가 된다.",
            ],
          },
          {
            type: "blankImage",
