...
Titles.prototype.createElements = function (doc, obj) {
  ...
  areaTextRef.contents = this.text.sub_titles.rev_main_title;
...
ExecMain.prototype.createDoc = function () {
  app.documents.addDocument("", this.titles.newdoc_setting(this.titles.createSetting["rev_main_title"]));
  var this_ai = app.activeDocument;
  this.titles.createElements(this_ai, this.titles.createSetting["rev_main_title"]);
  this.titles.createLines(this_ai, this.titles.createSetting["rev_main_title"]);
  return this_ai;
}

    
ExecMain.prototype.copyDoc = function (target) {
  var templateObj = new File(this.dir + "factory/template/review/subtitles/" + target + ".ai");
  ...
  function to_right(dom) {
    var c = dom.duplicate();
    var g = c.createOutline();
    var a = app.activeDocument.artboards[0].artboardRect;
...
ExecMain.prototype.start = function () {
  ...
  this_ai.close();
  var sub_list = [ "morevtivec", "name2", "nu", "resubti", "revhovec", "revtivec" ];
