 ...
 * 이 작업은 디자이너 경력 갱신을 처리하는 HTTP 요청을 보냅니다.
 */
 ...
 */
const dayId = [
  "d023", // 'd023'은 매일 오전 2시 30분에 실행되어야 함을 나타냅니다.
];
...
const worker = async function (package) {
  ...
  try {
     ...
     * 이 요청은 디자이너 경력 갱신을 처리하기 위한 것입니다.
     * - URL: address 객체의 officeinfo.ghost.host에 정의된 호스트를 사용합니다.
     * - 포트: 3000
     * - 엔드포인트: /refreshDesignerCareer
     ...
     * - 오류 메시지: "refresh designer career error : " + e.message - 발생한 오류의 메시지를 포함합니다.
