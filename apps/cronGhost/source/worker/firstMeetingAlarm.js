 ...
 */
const dayId = [
  "d151", // 'd151'은 매일 오후 3시 10분에 실행되어야 함을 나타냅니다.
];
...
const worker = async function (package) {
  ...
  try {
     ...
     * 이 요청은 첫 번째 미팅 알람과 관련된 작업을 처리하기 위한 것입니다.
     * - URL: address 객체의 officeinfo.host에 정의된 호스트와 포트 3002를 사용합니다.
     * - 엔드포인트: /timeDeltaAlarm
     ...
     * - 오류 메시지: "first meeting alarm error : " + e.message - 발생한 오류의 메시지를 포함합니다.
