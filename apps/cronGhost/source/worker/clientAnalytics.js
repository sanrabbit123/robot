 ...
 */
const dayId = [
  "d074", // 'd074'는 매일 오전 7시 40분에 실행되어야 함을 나타냅니다.
  "d104", // 'd104'는 매일 오전 10시 40분에 실행되어야 함을 나타냅니다.
  "d124", // 'd124'는 매일 오후 12시 40분에 실행되어야 함을 나타냅니다.
  "d154", // 'd154'는 매일 오후 3시 40분에 실행되어야 함을 나타냅니다.
  "d174", // 'd174'는 매일 오후 5시 40분에 실행되어야 함을 나타냅니다.
  "d204", // 'd204'는 매일 오후 8시 40분에 실행되어야 함을 나타냅니다.
];
...
const worker = async function (package) {
   ...
   * 이 메서드들은 각각 시스템 요청, 메시지 로깅, 오류 로깅, 비상 알람을 처리합니다.
   * @type {Function}
   */
  ...
  try {
     ...
     * - 오류 메시지: "client analytics error : " + e.message
