/**
 * 이 worker는 지정된 날짜에 실행되는 작업을 정의하고 있습니다.
 * 이 작업은 기록 백업 및 삭제를 처리하는 HTTP 요청을 보냅니다.
 */
 ...
 */
const dayId = [
  "d222", // 'd222'는 매일 오후 10시 20분에 실행되어야 함을 나타냅니다.
];
...
const worker = async function (package) {
  ...
  try {
     ...
     * 이 요청은 기록 백업 및 삭제를 처리하기 위한 것입니다.
     ...
     * - 오류 메시지: "record backup and delete error : " + e.message - 발생한 오류의 메시지를 포함합니다.
