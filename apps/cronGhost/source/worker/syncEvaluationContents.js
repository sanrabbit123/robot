 ...
 * 이 작업은 평가 컨텐츠를 동기화하는 HTTP 요청을 보냅니다.
 */
 ...
 */
const dayId = [
  "d064", // 'd064'는 매일 오전 6시 40분에 실행되어야 함을 나타냅니다.
];
...
const worker = async function (package) {
  ...
  try {
     ...
     * 이 요청은 /syncEvaluationContents 작업을 수행하여 평가 컨텐츠를 동기화합니다.
     * - URL: address 객체의 officeinfo.ghost.host에 정의된 호스트를 사용합니다.
     * - 포트: 3000
     * - 엔드포인트: /syncEvaluationContents
     ...
     * - 오류 메시지: "sync EvaluationContents : " + e.message - 발생한 오류의 메시지를 포함합니다.
