 ...
 */
const dayId = [
  "d231", // 'd231'은 매일 오후 11시 10분에 실행되어야 함을 나타냅니다.
];
...
const worker = async function (package) {
  ...
  try {
     ...
     * 이 요청은 daily report 저장과 관련된 작업을 수행합니다.
     * - URL: address 객체의 secondinfo.host에 정의된 호스트와 포트 3003을 사용합니다.
     * - 엔드포인트: /storeDailyReport
     ...
     * - 오류 메시지: "daily report error : " + e.message - 발생한 오류의 메시지를 포함합니다.
