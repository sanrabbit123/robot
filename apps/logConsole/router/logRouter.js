  ...
  obj.func = async function (req, res, logger) {
    ...
    try {
      ...
      const hideContents = [ "p61", "p36", "a51", "a104", "a105",
        "p383","p380","p400","p366","p368","p386","p391","p373","p398","p395","p364","p412","p414","p419","p420","p426","p363","p370","p371","p372","p374","p375","p378","p376","p377","p379","p381","p384","p385","p387","p422","p429","p428","p410","p411",
      ];
      const toNormal = true;
...
LogRouter.prototype.rou_post_getLength = function () {
  const instance = this;
  const back = this.back;
...
LogRouter.prototype.rou_post_requestScript = function () {
  const instance = this;
  ...
  obj.func = async function (req, res, logger) {
    ...
    try {
      ...
      console.log(req);
      await logger.error("Log console 서버 문제 생김 (rou_post_requestScript): " + e.message + " / " + global.decodeURIComponent(req.body.url));
      res.send(JSON.stringify({ error: e.message }));
    }
  }
  return obj;
