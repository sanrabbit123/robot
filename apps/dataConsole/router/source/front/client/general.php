...
class GeneralPhp {
  ...
  public function hiddenHtml ($hiddenString) {
    $html = '<header><h1>홈스타일링 플랫폼 : 홈리에종</h></header><nav><a href="/about.php" class="hiddenobject">홈스타일링 서비스 소개</a>'."\n";
    ...
    $html .= '<a href="/index.php" class="hiddenobject">홈리에종 홈페이지</div></nav>'."\n";
    ...
    $html .= '<footer><h1 class="hiddenobject">(주)홈리에종</h1>'."\n";
