      ...
      contents: [
        {
          ...
          contents: [
            {
              text: "디자이너와 미팅 후에는 계약금 환불이 불가해요.",
            },
            {
              text: "미팅 후 부득이하게 디자이너 변경이 필요한 경우에는 1회에 한하여 요청하실 수 있어요.",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          contents: [
            {
              text: "프로젝트 진행을 결정하시고 계약서 서명 및 잔금 입금을 완료하신 후에는 프로젝트의 중단 및 환불이 불가해요.",
            },
            {
      ...
      contents: [
        {
          ...
          contents: [
            {
              text: "홈스타일링 서비스(부분 시공 + 스타일링)를 진행하실 경우 3가지 시공사 선택이 가능해요.",
              children: [
                {
                  text: "홈리에종 시공사",
                },
            ...
            {
              text: "토탈 서비스, 엑스트라 토탈 서비스(전체 시공 + 스타일링)를 진행하실 경우 선택하신 디자이너에 따라 매칭 되는 시공사와 진행하시게 돼요.",
              children: [
                {
                  text: "홈리에종 시공사",
                },
            ...
            {
              text: "위와 같이 서비스 유형에 따라 시공사 선택지가 있지만, 디자이너에 따라 가능한 선택지가 달라져요. 디자이너 추천서에서 디자이너별 시공사 선택지를 확인하세요.",
            }
          ],
        },
        {
          ...
          contents: [
            ...
            { text: "선택하신 시공사와 직접 계약을 하셔야 해요." },
            { text: "시공 금액 지불 / 시공 업무 진행(공사 일정 세팅, 공사 인력 세팅, 공사 진행, 공사품질 관리감독(감리), 하자보수, A/S 등)  / 시공과 관련된 일체의 책임은 계약을 체결한 시공사에게 있어요. 시공과 관련한 사항은 홈리에종이나 디자이너가 아닌 해당 시공사에 문의하셔야 해요." },
            { text: "많이 문의하시는 “시공 감리”는 계약하신 시공사에서 진행하는 일이에요. 디자이너는 시공 감리를 하지 않아요." },
            { text: "디자이너는 시공 진행 시 전반적인 톤 앤 매너와 마감재 스펙을 제안해 드려요." },
            { text: "홈리에종 시공사 또는 디자이너 시공사가 아닌 타 시공사와 진행하실 경우에는 시공사와의 커뮤니케이션은 고객님께서 직접 해주셔야 해요." },
          ]
        },
        {
          title: "홈리에종 시공사",
          contents: [
            ...
            { text: "홈리에종 시공사와 계약 시 ①공사 시작일 최소 한 달 전 견적 의뢰 ②공사 시작일 최소 2주 전 시공 계약을 완료하셔야 해요. 홈리에종 시공사와 진행을 원하실 경우 프로젝트 초기에 의사를 알려주세요." },
            { text: "홈리에종 시공 계약의 경우 카드 결제가 불가하고 현금 결제만 가능해요. (홈리에종 외 일반 시공사들도 대체로 현금 결제만 가능한 편이에요)" },
            { text: "홈리에종 시공 계약의 경우 VAT 10%가 포함하고 현금 영수증 등 증빙을 발행해요." },
          ]
        },
        {
          title: "기타 시공 관련",
          contents: [
            {
              ...
              children: [
                ...
                { text: "진행 일정 논의 및 공사 진행 확인, 커뮤니케이션 등은 고객님께서 직접 해주셔야 해요. " },
              ]
            },
            {
            ...
            },
            {
              ...
              children: [
                ...
                { text: "거주 중에 가능한 시공 이상의 진행을 원하실 경우에는 집(짐과 고객님 가족 모두)을 비워 주셔야 해요." },
                { text: "소음과 먼지가 발생해요." },
                { text: "시공 인력과 마감 자재가 드나들어요." },
                { text: "보관 이사 또는 거주하실 집은 별도로 알아보셔야 해요." },
                { text: "거주 중 시공 시에는 공실인 집을 시공할 때 보다 시공 금액이 더 높은 편이에요." },
                { text: "공실인 상태에서 전체 시공을 하시는 경우가 아닐 경우, 보양을 하지만 진행 과정에서 스크래치가 생길 가능성이 높아요. 이 경우 별도로 A/S 해드리기 어려운 점을 감안하셔야 해요. " },
              ]
            },
          ]
        }
      ...
      contents: [
        {
          ...
          contents: [
            ...
            { text: "미팅은 평균적으로 2회 정도 진행해요. 첫 현장 미팅 1회와 마무리 미팅 1회가 포함되고 현장 상황 또는 선택하신 디자이너에 따라 미팅 횟수는 차이가 있어요." },
            { text: "커뮤니케이션은 미팅, 카톡, 문자, 전화, 메일 등으로 진행해요." },
            { text: "디자이너는 컨셉 이미지/컨셉 보드, 배치도, 구매 제품리스트를 필수 제공해드려요. 3D, 콜라주, 드로잉 등은 필수 제공 요소가 아니고 디자이너의 작업 방식에 따라 선택적으로 제공해드려요." },
            {
              ...
              children: [
                ...
                { text: "따라서 첫 디자인 제안이 나온 후에는 컨셉 내에서 세부 사항을 수정 및 발전시킬 수 있지만 컨셉 자체의 변경은 어려워요. 디자이너가 처음부터 다시 작업해야 되기 때문이에요." },
              ]
            },
            { text: "디자이너는 시공 범위를 제안해 드려요." },
            { text: "정해진 시공에 대해 톤 앤 매너의 제안 및 마감재 스펙을 제안해 드려요." },
            {
              text: "사용하는 제품 중 가져갈 제품과 정리할 제품을 제안해 드려요.",
              children: [
                { text: "사용하고 있는 제품들의 사진을 촬영해서 디자이너에게 보내주세요" },
                { text: "디자이너가 제안드린 가져갈 제품의 치수는 디자이너에게 보내주세요." },
                { text: "가져갈 가구는 이사 갈 집에서 어디에 어떻게 사용할지 디자이너가 제안해드려요" },
                { text: "정리할 제품은 이사하시면서 정리하시고 오시면 돼요." },
              ]
            },
        ...
        },
        {
          title: "디자인비 조정",
          contents: [
            { text: "시공 범위가 추가되어 서비스 유형이 변경되거나 서비스 대상 면적이 추가되면 기간과 디자인비가 조정돼요." },
      ...
      contents: [
        {
          ...
          contents: [
            ...
            { text: "결제 방식, 증빙, 조립/설치, 배송, 교환/환불, 하자/보수는 해당 구매처와 이야기하셔야 해요." },
            { text: "제작 패브릭, 제작 가구 등 제작 제품은 교환/환불이 불가해요." },
          ]
        },
        {
          title: "제품 수령 및 세팅",
          contents: [
            { text: "배송된 제품의 수령, 언박싱, 조립/설치, 1차 배치는 고객님께서 진행하시게 돼요." },
        ...
        },
        {
          ...
          contents: [
            ...
            { text: "최종 선택 및 결정에 대한 책임은 고객님께 있기 때문에, 신중하게 선택하셔야 해요." },
          ]
        },
      ]
    }
...
ContractCautionJs.prototype.whiteBlockRender = function (thisIndex, mainTitle, mainContents) {
  ...
  numberTongWidth = <%% 72, 72, 72, 60, 0 %%>;
  secondNumberTongWidth = <%% 70, 70, 70, 56, 0 %%>;
      ...
      children: [
        ...
        },
        {
          ...
          children: (new Array(contents.length)).fill(null).map((n, index) => {
            ...
            arr = [
              {
                text: `<div style="display:inline-block;position:relative;width:${String(checkBoxWidth) + ea};margin-right:${String(checkBoxMarginRight) + ea};">${instance.mother.returnCheckBox(colorChip.green)}</div>${String(thisIndex + 1)}-${String(num2 + 1)}-${String(1 + index)}`,
                style: {
                  display: "inline-block",
                  position: "relative",
