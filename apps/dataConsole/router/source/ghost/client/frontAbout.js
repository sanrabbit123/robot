...
FrontAboutJs.prototype.insertInitBox = async function () {
  const instance = this;
        ...
        children: [
          {
            mode: "img",
            attribute: {
              src: FrontAboutJs.binaryPath + "/frontIndexSource0.png",
            },
            style: {
              display: "inline-block",
              position: "relative",
      ...
      imageBlock = createNode({
        ...
        children: [
          ...
          },
          {
            mode: "img",
            attribute: {
              src: FrontAboutJs.binaryPath + "/frontIndexSourceDesktop0.png",
            },
            style: {
              display: "inline-block",
              position: "relative",
...
FrontAboutJs.prototype.insertSecondBox = async function () {
  const instance = this;
...
FrontAboutJs.prototype.insertReviewBox = async function (secondBase) {
  const instance = this;
...
FrontAboutJs.prototype.insertThirdBox = async function () {
  const instance = this;
  const { withOut, returnGet, createNode, colorChip, colorExtended, isMac, isIphone, svgMaker, serviceParsing, dateToString, dateToHangul, stringToDate, findByAttribute, autoHypenPhone, setQueue, uniqueValue, homeliaisonAnalytics, objectDeepCopy } = GeneralJs;
  const { ea, media, baseTong, standardWidth, naviHeight, heightTong } = this;
  const mobile = media[4];
    ...
    if (mobile) {
      ...
      createNode({
        ...
        child: {
          mode: "img",
          attribute: {
            src: FrontAboutJs.binaryPath + "/frontIndexSource3.png",
          },
          style: {
            display: "inline-block",
            position: "relative",
...
FrontAboutJs.prototype.insertConsultingBox = async function (lastMode = false) {
  const instance = this;
...
FrontAboutJs.prototype.insertServiceDetailBox = async function (secondBaseMother = null, serviceIndex = 0) {
  const instance = this;
    ...
    furnishingObj = {
      ...
      solve: {
        ...
        images: [
          ...
          FrontAboutJs.binaryPath + "/furnishingSource2.jpg",
          FrontAboutJs.binaryPath + "/furnishingSource3.jpg",
        ],
      }
    };
    stylingObj = {
      ...
      solve: {
        ...
        images: [
          ...
          FrontAboutJs.binaryPath + "/stylingSource2.jpg",
          FrontAboutJs.binaryPath + "/stylingSource3.jpg",
        ],
      }
    };
    totalObj = {
      ...
      solve: {
        ...
        images: [
          ...
          FrontAboutJs.binaryPath + "/totalSource2.jpg",
          FrontAboutJs.binaryPath + "/totalSource3.jpg",
        ],
      }
    };
    contents = [];
...
FrontAboutJs.prototype.insertWhiteCardEvent = function (serviceIndex) {
  const instance = this;
...
FrontAboutJs.prototype.portfolioBlock = function (limitLength, search = null, sort = "key9") {
  const instance = this;
