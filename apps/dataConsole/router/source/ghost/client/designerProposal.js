...
DesignerProposalJs.prototype.insertInitBox = async function () {
  const instance = this;
  ...
  try {
    ...
    mainIllust = <%% DesignerProposalJs.binaryPath + "/mainIllust0.png", DesignerProposalJs.binaryPath + "/mainIllust1.png", DesignerProposalJs.binaryPath + "/mainIllust2.png", DesignerProposalJs.binaryPath + "/mainIllust2.png", DesignerProposalJs.binaryPath + "/mainIllust1.png" %%>;
...
DesignerProposalJs.prototype.insertSecondBox = async function () {
  const instance = this;
...
DesignerProposalJs.prototype.insertThirdBox = async function () {
  const instance = this;
...
DesignerProposalJs.prototype.insertThirdPlusBox = async function () {
  const instance = this;
...
DesignerProposalJs.prototype.insertServiceBox = function (thisBase) {
  const instance = this;
  const { ea, media } = this;
...
DesignerProposalJs.prototype.insertWordBox = function (thisBase) {
  const instance = this;
  const { ea, media } = this;
  const mobile = media[4];
  const desktop = !mobile;
...
DesignerProposalJs.prototype.insertFourthBox = async function () {
  const instance = this;
...
DesignerProposalJs.prototype.styleTextParsing = function (text, sourceMode = false) {
  try {
...
DesignerProposalJs.prototype.imageViewing = function (images, convertMode = true) {
  const instance = this;
...
DesignerProposalJs.prototype.insertWhiteCardEvent = function (desid, char) {
  const instance = this;
...
DesignerProposalJs.prototype.resizeEvent = function () {
  const instance = this;
...
DesignerProposalJs.prototype.designerFinalSelection = function (fromCard = false, thisDesid = null) {
  const instance = this;
  const { withOut, returnGet, createNode, colorChip, colorExtended, autoComma, isMac, isIphone, svgMaker, serviceParsing, dateToString, stringToLink, designerCareer, stringToDate, findByAttribute, autoHypenPhone, setQueue, uniqueValue, homeliaisonAnalytics } = GeneralJs;
  const { ea, media, baseTong, standardWidth, naviHeight, blankPhoto } = this;
  const mobile = media[4];
...
DesignerProposalJs.prototype.finalSubmit = async function (desid) {
  const instance = this;
...
DesignerProposalJs.prototype.launching = async function (loading) {
  ...
  try {
    ...
    blankPhoto = DesignerProposalJs.binaryPath + "/blank.png";
    ...
    console.log(err);
    await GeneralJs.ajaxJson({ message: "DesignerProposalJs.launching 에러 일어남 => " + err.message }, BACKHOST + "/errorLog");
  }
}
