...
AboutServiceJs.binaryPath = FRONTHOST + "/middle/index";
...
AboutServiceJs.prototype.insertInitBox = async function () {
  const instance = this;
        ...
        children: [
          {
            mode: "img",
            attribute: {
              src: AboutServiceJs.binaryPath + "/frontIndexSource0.png",
            },
            style: {
              display: "inline-block",
              position: "relative",
      ...
      imageBlock = createNode({
        ...
        children: [
          ...
          },
          {
            mode: "img",
            attribute: {
              src: AboutServiceJs.binaryPath + "/frontIndexSourceDesktop0.png",
            },
            style: {
              display: "inline-block",
              position: "relative",
...
AboutServiceJs.prototype.insertSecondBox = async function () {
  const instance = this;
  ...
  try {
    ...
    createNode({
      ...
      mode: "img",
      attribute: {
        src: AboutServiceJs.binaryPath + "/clickMe.png",
      },
      style: {
        display: "inline-block",
        position: "absolute",
...
AboutServiceJs.prototype.insertReviewBox = async function (secondBase) {
  const instance = this;
...
AboutServiceJs.prototype.insertThirdBox = async function () {
  const instance = this;
  const { withOut, returnGet, createNode, colorChip, colorExtended, isMac, isIphone, svgMaker, serviceParsing, dateToString, dateToHangul, stringToDate, findByAttribute, autoHypenPhone, setQueue, uniqueValue, homeliaisonAnalytics, objectDeepCopy } = GeneralJs;
  const { ea, media, baseTong, standardWidth, naviHeight, heightTong } = this;
  const mobile = media[4];
  ...
  try {
    ...
    createNode({
      ...
      child: {
        mode: "img",
        attribute: {
          src: AboutServiceJs.binaryPath + "/frontIndexSource1.png",
        },
        style: {
          display: "inline-block",
    ...
    if (mobile) {
      ...
      createNode({
        ...
        mode: "img",
        attribute: {
          src: AboutServiceJs.binaryPath + (desktop ? "/frontIndexSource4Desktop.png" : "/frontIndexSource4.png"),
        },
        style: {
          display: "inline-block",
          position: "relative",
    ...
    createNode({
      ...
      child: {
        mode: "img",
        attribute: {
          src: AboutServiceJs.binaryPath + "/frontIndexSource2.png",
        },
        style: {
          display: "inline-block",
          position: mobile ? "relative" : "absolute",
    ...
    if (mobile) {
      ...
      createNode({
        ...
        child: {
          mode: "img",
          attribute: {
            src: AboutServiceJs.binaryPath + "/frontIndexSource3.png",
          },
          style: {
            display: "inline-block",
            position: "relative",
...
AboutServiceJs.prototype.insertConsultingBox = async function (lastMode = false) {
  const instance = this;
...
AboutServiceJs.prototype.insertServiceDetailBox = async function (secondBaseMother = null, serviceIndex = 0) {
  const instance = this;
  ...
  try {
    ...
    furnishingObj = {
      ...
      solve: {
        ...
        images: [
          AboutServiceJs.binaryPath + "/furnishingSource0.jpg",
          AboutServiceJs.binaryPath + "/furnishingSource1.jpg",
          AboutServiceJs.binaryPath + "/furnishingSource2.jpg",
          AboutServiceJs.binaryPath + "/furnishingSource3.jpg",
        ],
      }
    };
    stylingObj = {
      ...
      solve: {
        ...
        images: [
          AboutServiceJs.binaryPath + "/stylingSource0.jpg",
          AboutServiceJs.binaryPath + "/stylingSource1.jpg",
          AboutServiceJs.binaryPath + "/stylingSource2.jpg",
          AboutServiceJs.binaryPath + "/stylingSource3.jpg",
        ],
      }
    };
    totalObj = {
      ...
      solve: {
        ...
        images: [
          AboutServiceJs.binaryPath + "/totalSource0.jpg",
          AboutServiceJs.binaryPath + "/totalSource1.jpg",
          AboutServiceJs.binaryPath + "/totalSource2.jpg",
          AboutServiceJs.binaryPath + "/totalSource3.jpg",
        ],
      }
    };
    contents = [];
...
AboutServiceJs.prototype.insertWhiteCardEvent = function (serviceIndex) {
  const instance = this;
...
AboutServiceJs.prototype.insertPortfolioBase = function () {
  const instance = this;
...
AboutServiceJs.prototype.portfolioBlock = function (limitLength, search = null, sort = "key9") {
  const instance = this;
...
AboutServiceJs.prototype.resizeEvent = function () {
  const instance = this;
...
AboutServiceJs.prototype.launching = async function (loading) {
  ...
  try {
    ...
    await this.mother.ghostClientLaunching({
      ...
      local: async () => {
        try {
          ...
          await GeneralJs.ajaxJson({ message: "AboutServiceJs.launching.ghostClientLaunching : " + e.message }, BACKHOST + "/errorLog");
        }
      }
    });
    ...
    console.log(err);
    await GeneralJs.ajaxJson({ message: "AboutServiceJs.launching 에러 일어남 => " + err.message }, BACKHOST + "/errorLog");
  }
}
