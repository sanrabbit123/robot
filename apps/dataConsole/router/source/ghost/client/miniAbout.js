  ...
  contents = [
    {
      ...
      description: [
        ...
        (desktop ? "기존 가구를 그대로 사용하면 공간 분위기가 바뀌지 않을까 걱정이신가요? <b%패브릭, 소품, 액자만 바꿨을 뿐인데, 분위기가 완전 달라질 수 있어요.%b> 신뢰할 수 있는 전문가를 믿고 따라오세요." : "패브릭, 소품, 액자만으로 <b%분위기 환골탈태!%b>"),
    ...
    faq: [
      {
        ...
        answer: "홈리에종 mini 서비스는 <b%기존 가구를 그대로 활용하되 패브릭, 소품, 액자의 합리적인 비용으로 내 공간의 무드를 크게 변화시킬 수 있는 라이트한 서비스로 제공%b>하고 있습니다. 가구 체인지 도움이 필요하시다면 홈리에종의 온/오프라인 서비스를 이용해보세요!",
        important: true,
      },
      {
        question: "디자이너를 선택할 수 있나요?",
        answer: "홈리에종 mini 서비스는 <b%홈리에종의 전문적인 교육을 받은 디자이너가 프로젝트를 담당%b>합니다. 특화된 서비스에 맞게 홈리에종에서 디자이너 모두 동일한 mini 서비스를 제공하기 때문에 따로 지정을 하지 않고, 자동 배치하여 빠른 서비스로 만나 볼 수 있어요!",
        important: false,
      },
      {
        question: "기간은 얼마나 소요되나요?",
        answer: "홈리에종 mini 서비스는 큰 가구의 제작 기간이나 맞춤 제작 상품을 제안하지 않고, 빠른 시일 내 가장 어울리는 우리집의 모습을 보여드리기 위해 기성 제품을 추천드리고 있어요. 각 제품을 판매하고 있는 판매처의 상황에 따라 다를 수 있지만, <b%디자이너의 제안은 고객님께서 전달해 주실 기본 정보를 받는 기준, 3일 내로 내 공간을 위한 나만의 시안을 받아보실 수 있답니다!%b> (*구매처의 배송 기간에 따라 완료까지 소요되는 기간이 상이할 수 있습니다.)",
        important: false,
      },
      {
        question: "배치도 해주시나요?",
      ...
      },
      {
        ...
        answer: "나 혼자 하기 어려웠던 실측, 이젠 걱정하지 마세요! <b%실측 가이드를 제공하여 쉽고 빠르게 직접 실측할 수 있도록%b> 홈리에종이 도와드려요!",
        important: false,
      },
      {
        question: "디자이너 제안서는 어떤 내용으로 제안받나요?",
        answer: "디자이너의 제안서는 고객에게 제공받은 공간의 사이즈, 사진 속의 배치를 기반으로 고객님이 원하는 무드에 대해 상담 후, <b%디자이너와 약속된 컨셉과 무드의 공간을 시각화한 자료를 통해 제안서로 제공%b>받게 됩니다. 시각화 자료는 실제 제품의 재질, 조화를 잘 고려함을 보여주기 위해 3D가 아닌 평면적인 콜라주 형태의 제안서로 제공됩니다.",
        important: false,
      },
      {
        question: "디자인 제안받은 후에 수정도 가능할까요?",
        answer: "디자이너는 고객과의 상담 내용을 바탕으로 디자인 작업을 진행하게 됩니다. <b%따라서 상담 내용과 다른 내용의 수정 제안서는 제공되지 않기 때문에%b> 디자이너와 상담 시, 부담 없이 원하는 부분에 대해 상세하게 설명을 해주시면 원하는 방향의 스타일링을 받으실 수 있어요!",
        important: false,
      },
    ],
    final: {
    ...
    rules: [
      {
        ...
        description: [
          ...
          <&& "디자이너와의 상담이 시작된 이후에는 결제 취소가 불가합니다." | "디자이너와의 상담이 시작된 이후에는 취소가 불가합니다." | "디자이너와 상담이 시작된 이후에는 취소가 불가합니다." | "디자이너와 상담이 시작된 이후에는 취소가 불가합니다." | "디자이너와 상담이 시작된 이후에는 취소가 불가합니다." &&>,
        ]
      },
      {
        title: "환불 규정",
