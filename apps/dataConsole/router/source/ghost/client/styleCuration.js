            ...
            update: function (value, siblings, client) {
              if (value !== null) {
                ...
                if (thisValue <= 1200 * man) {
                  finalValue = menu[1];
                } else if (thisValue > 1200 * man && thisValue <= 1600 * man) {
                  finalValue = menu[2];
                } else if (thisValue > 1600 * man && thisValue <= 2300 * man) {
                  finalValue = menu[3];
                } else if (thisValue > 2300 * man && thisValue <= 2600 * man) {
                  finalValue = menu[4];
                } else if (thisValue > 2600 * man && thisValue <= 3200 * man) {
                  finalValue = menu[5];
                } else if (thisValue > 3200 * man && thisValue <= 3600 * man) {
                  finalValue = menu[6];
                } else if (thisValue > 3600 * man && thisValue <= 4200 * man) {
                  finalValue = menu[7];
                } else if (thisValue > 4200 * man && thisValue <= 4600 * man) {
                  finalValue = menu[8];
                } else if (thisValue > 4600 * man && thisValue <= 5600 * man) {
                  finalValue = menu[9];
                } else if (thisValue > 5600 * man && thisValue <= 6600 * man) {
                  finalValue = menu[10];
                } else if (thisValue > 6600 * man && thisValue <= 7600 * man) {
                  finalValue = menu[11];
                } else if (thisValue > 7600 * man && thisValue <= 8600 * man) {
                  finalValue = menu[12];
                } else if (thisValue > 8600 * man && thisValue <= 9700 * man) {
                  finalValue = menu[13];
                } else {
                  finalValue = menu[14];
                }
