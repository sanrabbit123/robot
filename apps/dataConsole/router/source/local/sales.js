...
SalesJs.prototype.whiteCardView = function (proid, columnArr, valueArr) {
  const instance = this;
...
SalesJs.prototype.reloadMenuArea = async function (project) {
  const instance = this;
...
SalesJs.prototype.insertFormStatusBox = async function (project, contentsArea) {
  const instance = this;
...
SalesJs.prototype.insertUploadBox = function (project, baseTong) {
  const instance = this;
  const mother = this.mother;
  const { ea, media } = this;
  const client = project.client;
...
SalesJs.prototype.insertScheduleBox = async function (project, baseTong) {
  const instance = this;
  const mother = this.mother;
...
SalesJs.prototype.uploadFiles = function (project, thisStatusNumber, photoBoo) {
  const instance = this;
  const mother = this.mother;
...
SalesJs.prototype.dropFiles = function (project, thisStatusNumber, photoBoo) {
  const instance = this;
  const mother = this.mother;
...
SalesJs.prototype.uploadLink = function (project, thisStatusNumber) {
  const instance = this;
  const mother = this.mother;
  const { createNode, createNodes, withOut, colorChip, serviceParsing, ajaxJson, ajaxForm, stringToDate, dateToString, cleanChildren, isMac, equalJson, isIphone, svgMaker } = GeneralJs;
  const { ea, media, totalContents } = this;
...
SalesJs.prototype.plusMemo = function (project, thisStatusNumber, customKey = null, customTitle = null) {
  const instance = this;
  const mother = this.mother;
  const { createNode, createNodes, withOut, colorChip, serviceParsing, ajaxJson, ajaxForm, stringToDate, dateToString, cleanChildren, isMac, equalJson, isIphone, svgMaker } = GeneralJs;
  const client = project.client;
...
SalesJs.prototype.setPanBlocks = async function (project) {
  const instance = this;
  const { ea, media, totalContents } = this;
  const mobile = media[4];
  const desktop = !mobile;
...
SalesJs.prototype.isEmptyString = function (string) {
  const instance = this;
...
SalesJs.prototype.asyncLoadingBlock = function () {
  const instance = this;
  const mother = this.mother;
