...
ProcessJs.prototype.extractMatrix = function () {
  const instance = this;
  const { totalContents, ea, belowHeight, projects } = this;
...
ProcessJs.prototype.searchMatrix = function () {
  const instance = this;
...
ProcessJs.prototype.reportMatrix = function () {
  const instance = this;
  const { totalContents, ea, belowHeight, projects } = this;
  const { ajaxJson, uniqueValue, blankHref } = GeneralJs;
...
ProcessJs.prototype.queueView = function () {
  const instance = this;
  const { totalContents, ea, belowHeight } = this;
...
ProcessJs.prototype.refundView = function () {
  const instance = this;
  const { totalContents, ea, belowHeight } = this;
  const { createNode, withOut, colorChip, isMac, blankHref, ajaxJson, cleanChildren, autoComma, dateToString, stringToDate, copyJson, removeByClass } = GeneralJs;
  return async function (e) {
...
ProcessJs.prototype.makeExcuteEvent = function (bilid, responseIndex, proid, queueMode = false) {
  const instance = this;
...
ProcessJs.prototype.makeRefundEvent = function (bilid, requestIndex, proid) {
  const instance = this;
  const { setQueue } = GeneralJs;
  return async function (e) {
    try {
...
ProcessJs.prototype.makeCashRefundEvent = function (refundRequest) {
  const instance = this;
  const { setQueue } = GeneralJs;
...
ProcessJs.prototype.makeRepayEvent = function (bilid, responseIndex, proid) {
  const instance = this;
  const { setQueue } = GeneralJs;
  return async function (e) {
    try {
...
ProcessJs.prototype.cashRefund = async function (refundRequestString) {
  const instance = this;
...
ProcessJs.prototype.dateFixEvent = function (bilid, responseIndex, proid, queueMode = false) {
  const instance = this;
...
ProcessJs.prototype.amountFixEvent = function (bilid, responseIndex, proid, queueMode = false) {
  const instance = this;
...
ProcessJs.prototype.excuteResponse = async function (bilid, responseIndex, date) {
...
ProcessJs.prototype.excuteRefund = async function (bilid, requestIndex, proid) {
...
ProcessJs.prototype.excuteRepay = async function (bilid, responseIndex, date, amount) {
