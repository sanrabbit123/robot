...
GeneralJs.prototype.generalCss = function () {
  ...
  *::-webkit-scrollbar{display:none;}
  ...
  input::placeholder {color:${(/consulting/gi.test(window.location.pathname) || /reviewList/gi.test(window.location.pathname) || /front/gi.test(window.location.pathname)) ? GeneralJs.colorChip.black : GeneralJs.colorChip.white};opacity:0.5;}
