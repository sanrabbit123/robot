...
GeneralJs.prototype.generalCss = function () {
  ...
  *::-webkit-scrollbar{display:none;}
  ...
  textarea::placeholder {color:${(/home\-liaison\.com/gi.test(window.location.host) || /consulting/gi.test(window.location.pathname) || /miniAbout/gi.test(window.location.pathname) || /miniGuide/gi.test(window.location.pathname) || /miniRequest/gi.test(window.location.pathname) || /miniProposal/gi.test(window.location.pathname)) ? GeneralJs.colorChip.black : GeneralJs.colorChip.white};opacity:0.5;}
