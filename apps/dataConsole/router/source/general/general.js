...
GeneralJs.prototype.generalCss = function () {
  ...
  *::-webkit-scrollbar{display:none;}
  ...
  input::placeholder {color:${(/home\-liaison\.com/gi.test(window.location.host) || /consulting/gi.test(window.location.pathname) || /reviewList/gi.test(window.location.pathname) ||  /portfolioList/gi.test(window.location.pathname) ||  /designerList/gi.test(window.location.pathname) || /front/gi.test(window.location.pathname) || /miniAbout/gi.test(window.location.pathname) || /miniProposal/gi.test(window.location.pathname)) ? GeneralJs.colorChip.black : GeneralJs.colorChip.white};opacity:0.5;}
