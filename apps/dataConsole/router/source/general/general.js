...
GeneralJs.prototype.generalCss = function () {
  ...
  *::-webkit-scrollbar{display:none;}
  ...
  input::placeholder {color:${/middle/gi.test(window.location.pathname) ? GeneralJs.colorChip.black : GeneralJs.colorChip.white};opacity:0.5;}
  textarea::placeholder {color:${/middle/gi.test(window.location.pathname) ? GeneralJs.colorChip.black : GeneralJs.colorChip.white};opacity:0.5;}
