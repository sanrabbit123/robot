...
DataPatch.prototype.clientMap = function () {
  const map = {
    ...
    comment: { name: "요청 사항", position: "requests.0.request.etc.comment", type: "date", searchBoo: false, },
    channel: { name: "유입 채널", position: "requests.0.request.etc.channel", type: "date", searchBoo: true, },
    status: { name: "상태", position: "requests.0.analytics.response.status", type: "date", searchBoo: true, },
