    ...
    try {
      ...
      for (let i = 0; i < tong.length; i++) {
        ...
        if (row1.length > 0) {
          ...
          process.contract.first.cancel = EMPTYDATE;
          ...
          process.contract.first.calculation.refund = 0;
          ...
          process.contract.remain.cancel = EMPTYDATE;
          ...
          process.calculation.payments.first.cancel = EMPTYDATE;
          process.calculation.payments.first.refund = 0;
          ...
          process.calculation.payments.remain.cancel = EMPTYDATE;
          process.calculation.payments.remain.refund = 0;
          ...
          tong[i].process.contract.first.cancel = EMPTYDATE;

          tong[i].process.contract.remain.guide = EMPTYDATE;
          tong[i].process.contract.remain.date = EMPTYDATE;
          tong[i].process.contract.remain.cancel = EMPTYDATE;
          ...
          tong[i].process.contract.form.date.cancel = EMPTYDATE;

          tong[i].process.contract.meeting.date = EMPTYDATE;

          tong[i].process.calculation.payments.first.date = EMPTYDATE;
          tong[i].process.calculation.payments.first.cancel = EMPTYDATE;
          tong[i].process.calculation.payments.remain.date = EMPTYDATE;
          tong[i].process.calculation.payments.remain.cancel = EMPTYDATE;
