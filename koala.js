...
Koala.prototype.mongoToJson = async function () {
  const instance = this;
...
Koala.prototype.diskTest = function () {
  const instance = this;
...
Koala.prototype.infoObj = async function () {
  try {
...
Koala.prototype.memberObj = async function () {
  try {
...
Koala.prototype.infoUpdate = async function () {
  try {
...
Koala.prototype.memberUpdate = async function () {
  try {
...
Koala.prototype.dataConsole = function (noStatic = false) {
...
Koala.prototype.renderFrontPhp = async function () {
  const DataConsole = require(process.cwd() + "/apps/dataConsole/dataConsole.js");
  const app = new DataConsole();
  await app.renderFrontPhp();
}

Koala.prototype.renderDesignerPhp = async function () {
  const DataConsole = require(process.cwd() + "/apps/dataConsole/dataConsole.js");
  const app = new DataConsole();
  await app.renderDesignerPhp();
}

Koala.prototype.contentsMaker = function (button, arg) {
...
Koala.prototype.aliveTest = function () {
  const instance = this;
  const CronGhost = require(`${process.cwd()}/apps/cronGhost/cronGhost.js`);
  const app = new CronGhost();
...
Koala.prototype.proposalMaker = function (button, arg) {
  if (arg === undefined) {
...
Koala.prototype.requestMaker = async function (arg) {
...
Koala.prototype.portfolioFilter = function (boo, clientName, apartName, designerName, pid = "g0") {
...
Koala.prototype.frontUpdate = async function () {
  try {
    const FrontMaker = require(process.cwd() + "/apps/frontMaker/frontMaker.js");
    let fobot = new FrontMaker();
...
Koala.prototype.logConnect = async function () {
  try {
...
Koala.prototype.secondConnect = async function () {
  try {
...
Koala.prototype.transferConnect = async function () {
  try {
...
Koala.prototype.staticConnect = async function () {
  try {
...
Koala.prototype.basicConnect = async function () {
  try {
...
Koala.prototype.consoleSource = function () {
  const AiConsole = require(process.cwd() + "/apps/contentsMaker/aiConsole.js");
  let cobot = new AiConsole();
  cobot.console_maker();
}

Koala.prototype.recordCloud = async function (sw, boo = true) {
  try {
...
Koala.prototype.pythonCloud = async function () {
  try {
...
Koala.prototype.pythonWatcher = async function () {
  try {
    const ReceiptObserver = require(`${process.cwd()}/apps/receiptObserver/receiptObserver.js`);
    const app = new ReceiptObserver();
...
Koala.prototype.taxBill = async function () {
  try {
...
Koala.prototype.kakaoTokenGenerate = async function () {
  try {
    const KakaoTalk = require(`${process.cwd()}/apps/kakaoTalk/kakaoTalk.js`);
...
Koala.prototype.ultimateReflection = async function () {
  try {
...
Koala.prototype.coreReflection = async function () {
  try {
    const MongoReflection = require(`${process.cwd()}/apps/mongoReflection/mongoReflection.js`);
    const reflection = new MongoReflection();
...
Koala.prototype.frontReflection = async function () {
  try {
    const MongoReflection = require(`${process.cwd()}/apps/mongoReflection/mongoReflection.js`);
    const reflection = new MongoReflection();
...
Koala.prototype.mysqlReflection = async function () {
  try {
    const MongoReflection = require(`${process.cwd()}/apps/mongoReflection/mongoReflection.js`);
    const reflection = new MongoReflection();
...
Koala.prototype.localReflection = async function (arg = null) {
  try {
    const MongoReflection = require(`${process.cwd()}/apps/mongoReflection/mongoReflection.js`);
    const reflection = new MongoReflection();
    let target;
...
Koala.prototype.clientReportToSheets = async function () {
  try {
...
Koala.prototype.fixDir = async function (target) {
  try {
...
Koala.prototype.proposalToClient = async function () {
  try {
...
Koala.prototype.imageReady = async function () {
  try {
    const PortfolioFilter = require(process.cwd() + "/apps/portfolioFilter/portfolioFilter.js");
...
Koala.prototype.staticInSync = async function () {
  const instance = this;
...
Koala.prototype.sayHello = async function (message = null) {
  const instance = this;
  try {
    let text, channel;
    channel = "#error_log";
...
Koala.prototype.consoleHello = async function () {
  const instance = this;
  try {
    setTimeout(() => {
...
Koala.prototype.designerCalculation = async function () {
  try {
    const BackWorker = require(`${process.cwd()}/apps/backMaker/backWorker.js`);
    const work = new BackWorker();
...
Koala.prototype.positionWatch = async function () {
  try {
...
Koala.prototype.graphicServer = async function () {
  try {
    const GraphicBot = require(`${process.cwd()}/apps/graphicBot/graphicBot.js`);
    const app = new GraphicBot();
    app.botServer();
...
Koala.prototype.passiveSync = async function () {
  try {
    const BillMaker = require(`${process.cwd()}/apps/billMaker/billMaker.js`);
...
Koala.prototype.devAliveSync = async function () {
  try {
...
Koala.prototype.cronServer = async function () {
  try {
    const CronGhost = require(`${process.cwd()}/apps/cronGhost/cronGhost.js`);
...
Koala.prototype.localLog = async function () {
  const instance = this;
...
Koala.prototype.arpScan = async function () {
  const instance = this;
...
Koala.prototype.magazineMaker = function (mid) {
  const ResourceMaker = require(process.cwd() + "/apps/resourceMaker/resourceMaker.js");
  const app = new ResourceMaker();
  app.magazineMaker(mid).catch((err) => { console.log(err); })
}

Koala.prototype.launching = async function () {
  const instance = this;
